...
#import "RFEqualWidthsController.h"

@interface RFEqualWidthsController ()

@end

@implementation RFEqualWidthsController
...
- (void)setUp {
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-[button1]-[button2(==button1)]-|"
                                                                      ...
                                                                      metrics:metrics
                                                                        views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-topMargin-[button1(44)]"
                                                                      options:0
                                                                      metrics:metrics
                                                                        views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-topMargin-[button2(44)]"
                                                                      options:0
                                                                      metrics:metrics
                                                                        views:views]];
}
