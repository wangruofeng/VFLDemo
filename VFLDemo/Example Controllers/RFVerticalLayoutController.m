...
#import "RFVerticalLayoutController.h"

@interface RFVerticalLayoutController ()

@end

@implementation RFVerticalLayoutController
...
- (void)setUp {
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-sideMargin-[button1]-sideMargin-|"
                                                                      options:0
                                                                      metrics:metrics
                                                                        views:views]];
